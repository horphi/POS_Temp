...
namespace CerZen.Web
{
    [DependsOn(
        typeof(CerZenApplicationModule),
        typeof(CerZenEntityFrameworkCoreModule),
        typeof(CzAspNetJarvisCoreWebModule),
    ...
    public class CerZenWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CerZenWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CerZenApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CerZenWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CerZenWebCoreModule).Assembly);
        }
