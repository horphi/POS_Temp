...
using CerZen.Mobile.MAUI.Services.Tenants;

#if ANDROID
using CerZen.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace CerZen.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new CerZen.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
