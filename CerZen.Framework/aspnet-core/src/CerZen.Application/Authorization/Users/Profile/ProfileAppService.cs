...
using CerZen.Authorization.Users.Profile.Cache;
...
namespace CerZen.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CerZenAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CerZen",
