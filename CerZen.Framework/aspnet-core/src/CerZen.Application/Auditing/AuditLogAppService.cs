...
using CerZen.Auditing.Exporting;
using CerZen.Authorization;
using CerZen.Authorization.Users;
using CerZen.Dto;
using CerZen.EntityHistory;
using EntityHistoryHelper = CerZen.EntityHistory.EntityHistoryHelper;

namespace CerZen.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CerZenAppServiceBase, IAuditLogAppService
    {
