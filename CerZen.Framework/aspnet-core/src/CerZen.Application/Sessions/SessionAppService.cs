...
{
    public class SessionAppService : CerZenAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = CerZenConsts.Currency,
                        CurrencySign = CerZenConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = CerZenConsts.AllowTenantsToChangeEmailSettings,
