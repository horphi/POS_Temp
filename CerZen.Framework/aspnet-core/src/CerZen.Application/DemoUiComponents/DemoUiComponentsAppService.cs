...
using CerZen.DemoUiComponents.Dto;

namespace CerZen.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CerZenAppServiceBase, IDemoUiComponentsAppService
    {
