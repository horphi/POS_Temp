...
using CerZen.Migrations.Seed.Host;
...
namespace CerZen.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CerZenAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CerZenDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CerZenConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CerZenConsts.ConnectionStringName}", constring);
        }
