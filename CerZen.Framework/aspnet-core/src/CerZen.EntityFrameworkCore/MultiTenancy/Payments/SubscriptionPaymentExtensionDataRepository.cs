...
{
    public class SubscriptionPaymentExtensionDataRepository : CerZenRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CerZenDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
