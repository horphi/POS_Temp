...
{
    public class SubscriptionPaymentRepository : CerZenRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CerZenDbContext> dbContextProvider)
