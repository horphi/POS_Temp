...
using CerZen.EntityFrameworkCore.Repositories;

namespace CerZen.Organizations
{
    public class UserOrganizationUnitRepository : CerZenRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<CerZenDbContext> dbContextProvider)
