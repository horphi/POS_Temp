...
using CerZen.Url;
using CerZen.Web.Public.Startup;
using CerZen.Web.Session;
using CerZen.Web.UiCustomization;

namespace CerZen.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CerZenViewComponent
    {
