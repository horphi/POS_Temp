...
using CerZen.Core.Base;
using CerZen.Core.Extensions;
using CerZen.Dto;
using CerZen.Types;

namespace CerZen.Queries
{
    public class OrganizationUnitQuery : CerZenQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
