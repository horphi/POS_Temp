(function () {
    let _addFromDifferentTenantModal = new app.ModalManager({
        viewUrl: abp.appPath + 'WebApp/Chat/AddFromDifferentTenantModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Chat/_AddFromDifferentTenantModal.js',
    ...
    app.modals.AddFriendModal.create = function (lookupOptions) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'WebApp/Chat/AddFriendModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Chat/_AddFriendModal.js',
