(function ($) {
  app.modals.UserDelegationsModal = function () {
    ...
    var _createNewUserDelegationModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/CreateNewUserDelegationModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_CreateNewUserDelegationModal.js',
