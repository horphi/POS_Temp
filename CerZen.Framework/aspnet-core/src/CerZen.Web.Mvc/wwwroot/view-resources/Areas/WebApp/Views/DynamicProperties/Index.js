(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicProperty/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/DynamicProperties/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditDynamicPropertyModal',
      cssClass: 'scrollable-modal',
    });

    var _manageValuesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicProperty/ManageValuesModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/WebApp/Views/_Bundles/dynamic-properties-manage-values.min.js',
