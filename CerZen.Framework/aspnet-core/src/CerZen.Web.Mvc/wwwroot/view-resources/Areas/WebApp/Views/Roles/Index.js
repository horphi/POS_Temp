(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'CerZen.Authorization.Roles.Role';
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Roles/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Roles/_CreateOrEditModal.js',
