var DynamicEntityPropertyManager = (function () {
  return function () {
    ...
    let _dynamicPropertiesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/WebApp/Views/_Bundles/manage-dynamic-entity-property-values-modal.min.js',
