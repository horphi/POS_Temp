(function () {
  $(function () {
    ...
    var _editTextModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Languages/EditTextModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Languages/_EditTextModal.js',
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (baseValue) {
            return $('<span/>')
              .attr('title', baseValue || '')
              .html(app.utils.string.truncate(baseValue, 32) || '')[0].outerHTML;
          },
        },
        {
          targets: 3,
          ...
          render: function (targetValue) {
            return $('<span/>')
              .attr('title', targetValue || '')
              .html(app.utils.string.truncate(targetValue, 32) || '')[0].outerHTML;
          },
        },
        {
          targets: 4,
          ...
          rowAction: {
            element: $(
              '<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="' +
                app.localize('Edit') +
    ...
    $('#TextBaseLanguageSelectionCombobox,#TextTargetLanguageSelectionCombobox').select2({
      theme: 'bootstrap5',
    ...
    $('#TextSourceSelectionCombobox,#TargetValueFilterSelectionCombobox').select2({
      theme: 'bootstrap5',
      selectionCssClass: 'form-select',
      language: abp.localization.currentCulture.name,
      width: '100%'
