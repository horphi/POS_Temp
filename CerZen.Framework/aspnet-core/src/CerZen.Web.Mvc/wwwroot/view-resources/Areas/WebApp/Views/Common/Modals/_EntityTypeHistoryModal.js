(function () {
  ...
  app.modals.EntityTypeHistoryModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Common/EntityTypeHistoryModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Common/Modals/_EntityTypeHistoryModal.js',
