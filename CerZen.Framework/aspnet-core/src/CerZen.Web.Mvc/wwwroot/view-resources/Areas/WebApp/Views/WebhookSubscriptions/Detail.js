(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/WebhookSubscription/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/WebhookSubscriptions/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  window.location = '/WebApp/WebhookSubscription/WebhookEventDetail/' + data.record.webhookEventId;
                },
              },
            ],
          },
    ...
    function renameActivityToggleBtn() {
      $('#activity-toggle-btn').text(subscriptionData.IsActive ? app.localize('Deactivate') : app.localize('Activate'));
    }
