$(function () {
  ...
  var _addWidgetModal = new app.ModalManager({
    viewUrl: abp.appPath + 'WebApp/' + $('#DashboardName').val() + '/AddWidgetModal',
    scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/CustomizableDashboard/_AddWidgetModal.js',
