(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Languages/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Languages/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  document.location.href = abp.appPath + 'WebApp/Languages/Texts?languageName=' + data.record.name;
                },
              },
              {
