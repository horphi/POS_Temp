(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'CerZen.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Tenants/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Tenants/_FeaturesModal.js',
