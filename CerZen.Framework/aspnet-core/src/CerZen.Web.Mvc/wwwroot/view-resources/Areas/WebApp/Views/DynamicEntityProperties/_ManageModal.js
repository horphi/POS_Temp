(function () {
  app.modals.ManageDynamicEntityPropertyModal = function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicEntityProperty/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/DynamicEntityProperties/_CreateModal.js',
