(function () {
  $(function () {
    ...
    var _selectAnEntity = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicProperty/SelectAnEntityModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/DynamicProperties/_SelectAnEntityModal.js',
    ...
    var _manageDynamicEntityPropertyModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/DynamicEntityProperty/ManageModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/WebApp/Views/_Bundles/dynamic-entity-properties-manage-modal.min.js',
