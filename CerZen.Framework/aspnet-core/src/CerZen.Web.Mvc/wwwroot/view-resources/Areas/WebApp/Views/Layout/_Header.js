(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/MySettingsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_MySettingsModal.js',
    ...
    var changePasswordModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/ChangePasswordModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_ChangePasswordModal.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/ChangePictureModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_ChangePictureModal.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/LinkedAccountsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_LinkedAccountsModal.js',
    ...
    var userDelegationsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Profile/UserDelegationsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_UserDelegationsModal.js',
