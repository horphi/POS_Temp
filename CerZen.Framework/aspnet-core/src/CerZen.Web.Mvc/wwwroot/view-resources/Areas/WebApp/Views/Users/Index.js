(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Users/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Users/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditUserModal',
    });

    var _userPermissionsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Users/PermissionsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Users/_PermissionsModal.js',
              ...
              },
              {
                ...
                visible: function () {
                  return _dynamicEntityPropertyManager.canShow(
                    'CerZen.Authorization.Users.User'
                  );
                },
                action: function (data) {
                  _dynamicEntityPropertyManager.modal.open({
                    entityFullName: 'CerZen.Authorization.Users.User',
