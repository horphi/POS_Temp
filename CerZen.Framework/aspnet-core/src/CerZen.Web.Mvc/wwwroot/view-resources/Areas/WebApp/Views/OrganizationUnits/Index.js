(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/OrganizationUnits/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/OrganizationUnits/_CreateModal.js',
      modalClass: 'CreateOrganizationUnitModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/OrganizationUnits/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/OrganizationUnits/_EditModal.js',
      modalClass: 'EditOrganizationUnitModal',
    });

    var _addUserModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/OrganizationUnits/AddMemberModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/OrganizationUnits/_AddMemberModal.js',
    ...
    var _addRoleModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/OrganizationUnits/AddRoleModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/OrganizationUnits/_AddRoleModal.js',
    ...
    var roles = {
      ...
      remove: function (role) {
        ...
        abp.message.confirm(
          app.localize('RemoveRoleFromOuWarningMessage', role.displayName, organizationTree.selectedOu.displayName),
          app.localize('AreYouSure'),
          function (isConfirmed) {
            if (isConfirmed) {
              _organizationUnitService
