  ...
  app.modals.MySettingsModal = function () {
    ...
    this.init = function (modalManager) {
      ...
      let twoFactorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'WebApp/Profile/TwoFactorAuthenticationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_TwoFactorAuthenticationModal.js',
      ...
      var viewRecoveryCodesModal = new app.ModalManager({
        viewUrl: abp.appPath + 'WebApp/Profile/ViewRecoveryCodesModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_ViewRecoveryCodesModal.js',
      ...
      var removeAuthenticatorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'WebApp/Profile/RemoveAuthenticatorModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_RemoveAuthenticatorModal.js',
      ...
      var smsVerificationModal = new app.ModalManager({
        viewUrl: abp.appPath + 'WebApp/Profile/SmsVerificationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Profile/_SmsVerificationModal.js',
