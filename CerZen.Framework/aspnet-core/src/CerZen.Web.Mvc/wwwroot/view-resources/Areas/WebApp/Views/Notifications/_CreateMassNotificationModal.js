(function ($) {
    app.modals.CreateMassNotificationModal = function () {
        ...
        var _userLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'WebApp/Notifications/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Notifications/_UserLookupTableModal.js',
            modalClass: 'UserLookupTableModal',
        });

        var _organizationUnitLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'WebApp/Notifications/OrganizationUnitLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Notifications/_OrganizationUnitLookupTableModal.js',
        ...
        $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
            ...
            var isSMSSelected = selectedTargetNotifiers.indexOf("CerZen.Notifications.SmsRealTimeNotifier") >= 0;
