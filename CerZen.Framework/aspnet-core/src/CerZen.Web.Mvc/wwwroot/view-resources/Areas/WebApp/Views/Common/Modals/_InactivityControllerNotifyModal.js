(function () {
  ...
  app.modals.InactivityControllerNotifyModal.create = function () {
    var modal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Common/InactivityControllerNotifyModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/WebApp/Views/Common/Modals/_InactivityControllerNotifyModal.js',
