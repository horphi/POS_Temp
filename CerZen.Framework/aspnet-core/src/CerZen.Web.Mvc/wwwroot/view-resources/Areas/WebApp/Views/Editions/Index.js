(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Editions/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Editions/_EditModal.js',
      modalClass: 'EditEditionModal',
    });

    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      viewUrl: abp.appPath + 'WebApp/Editions/MoveTenantsToAnotherEdition',
      scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
