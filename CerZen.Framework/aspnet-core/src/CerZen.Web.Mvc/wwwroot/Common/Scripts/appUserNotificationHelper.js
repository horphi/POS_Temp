...
(function ($) {
  app.UserNotificationHelper = (function () {
    return function () {
      ...
      /* Example:
            abp.notifications.messageFormatters['CerZen.MyNotificationDataType'] = function(userNotification) {
      ...
      function getUrl(userNotification) {
        switch (userNotification.notification.notificationName) {
          case 'App.NewUserRegistered':
            return '/WebApp/users?filterText=' + userNotification.notification.data.properties.emailAddress;
          case 'App.NewTenantRegistered':
            return '/WebApp/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
      ...
      var openSettingsModal = function () {
        new app.ModalManager({
          viewUrl: abp.appPath + 'WebApp/Notifications/SettingsModal',
          scriptUrl: abp.appPath + 'view-resources/Areas/WebApp/Views/Notifications/_SettingsModal.js',
