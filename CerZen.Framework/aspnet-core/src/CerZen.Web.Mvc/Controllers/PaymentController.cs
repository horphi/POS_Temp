...
using CerZen.Url;
using CerZen.Web.Models.Payment;
using System;
...
{
    public class PaymentController : CerZenControllerBase
    {
                ...
                if (tenant.EditionId.HasValue)
                {
                    ...
                    if (((SubscribableEdition)currentEdition).IsFree)
                    {
                        ...
                        if (((SubscribableEdition)upgradeEdition).IsFree)
                        {
                            ...
                            return RedirectToAction("Index", "SubscriptionManagement", new { area = "WebApp" });
                        }
