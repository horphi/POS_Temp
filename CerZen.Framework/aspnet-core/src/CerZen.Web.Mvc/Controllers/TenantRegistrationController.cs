...
using CerZen.Web.Models.TenantRegistration;

namespace CerZen.Web.Controllers
{
    public class TenantRegistrationController : CerZenControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "WebApp" }));
                    }
