...
using Cz.AspNetJarvisCore.Web.Authentication.JwtBearer;
...
using CerZen.Schemas;
using CerZen.Web.Chat.SignalR;
using CerZen.Web.Common;
using CerZen.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using CerZen.Web.Swagger;
using Stripe;
...
using CerZen.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using CerZen.Web.Extensions;
using CerZen.Web.MultiTenancy;
using SecurityStampValidatorCallback = CerZen.Identity.SecurityStampValidatorCallback;
...
namespace CerZen.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<CerZenWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (CerZenConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "CerZen API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("CerZen.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "CerZen API", Version = "v1"});
                ...
                var applicationXml = $"CerZen.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"CerZen.Web.Core.xml";
