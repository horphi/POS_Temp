...
namespace CerZen.Web.Areas.WebApp.Views.Shared.Components.WebAppMenu
{
    public class WebAppMenuViewComponent : CerZenViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public WebAppMenuViewComponent(
            ...
            string topMenuClass = "menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0")
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(WebAppNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
                Height = height,
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, WebAppPageNames.Tenant.SubscriptionManagement);
