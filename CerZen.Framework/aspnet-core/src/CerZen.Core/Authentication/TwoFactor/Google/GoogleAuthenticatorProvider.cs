...
namespace CerZen.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CerZenServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CerZen", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
