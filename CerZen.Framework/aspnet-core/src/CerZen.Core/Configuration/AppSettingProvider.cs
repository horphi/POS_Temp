...
namespace CerZen.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!CerZenConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        CerZenConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        CerZenDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        CerZenDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = CerZenDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = CerZenDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = CerZenDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    CerZenDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = CerZenDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = CerZenDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    CerZenDashboardCustomizationConsts.Widgets.Tenant
