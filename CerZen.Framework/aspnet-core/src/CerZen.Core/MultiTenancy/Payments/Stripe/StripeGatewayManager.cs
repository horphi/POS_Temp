...
{
    public class StripeGatewayManager : CerZenServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CerZen";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CerZenConsts.Currency;
        }
