...
using Cz.AspNetJarvisCore.Timing;
...
using CerZen.Authorization.Ldap;
using CerZen.Authorization.Roles;
using CerZen.Authorization.Users;
using CerZen.Chat;
using CerZen.Configuration;
using CerZen.DashboardCustomization.Definitions;
using CerZen.Debugging;
using CerZen.DynamicEntityProperties;
using CerZen.Features;
using CerZen.Friendships;
using CerZen.Friendships.Cache;
using CerZen.Localization;
using CerZen.MultiTenancy;
using CerZen.Net.Emailing;
using CerZen.Notifications;
using CerZen.WebHooks;
using Newtonsoft.Json;

namespace CerZen
{
    [DependsOn(
        typeof(CerZenCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(CzAspNetJarvisCoreModule),
        typeof(AbpMailKitModule))]
    public class CerZenCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CerZenLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CerZenConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CerZenMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CerZenSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CerZenCoreModule).GetAssembly());
        }
