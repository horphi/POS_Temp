...
using CerZen.MultiTenancy.HostDashboard;
...
namespace CerZen.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CerZenDbContext context, SubscriptionPayment subscriptionPayment)
        {
