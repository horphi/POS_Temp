...
$webHostFolder = Join-Path $slnFolder "src/CerZen.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/CerZen.Web.Public"
...
dotnet dev-certs https -v -ep cerzen-devcert-host.pfx -p 2825e4d9-5cef-4373-bed3-d7ebf59de216

docker rmi cerzenwebhost -f
...
Remove-Item ("Dockerfile")
Rename-Item -Path "Dockerfile.original" -NewName "Dockerfile"
dotnet dev-certs https -v -ep cerzen-devcert-public.pfx -p b7ca126d-5085-47a0-8ac3-1b5971bd65a1

docker rmi cerzenwebpublic -f
docker compose -f docker-compose.yml build
