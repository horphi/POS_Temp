...
$webMvcFolder = Join-Path $slnFolder "src/CerZen.Web.Mvc"
...
dotnet dev-certs https -v -ep cerzen-devcert-mvc.pfx -p 2825e4d9-5cef-4373-bed3-d7ebf59de216

docker rmi cerzenwebmvc -f
