...
export class TenantsComponent extends AppComponentBase implements OnInit {
    ...
    _entityTypeFullName = 'CerZen.MultiTenancy.Tenant';
    ...
    impersonateUser(item: NameValueDto): void {
        this._impersonationService.impersonateTenant(parseInt(item.value), this.impersonateUserLookupModal.tenantId);
    }
